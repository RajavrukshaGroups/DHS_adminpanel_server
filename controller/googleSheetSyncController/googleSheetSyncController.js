...
const SHEET_RANGE = process.env.GOOGLE_SHEET_RANGE || "Uploadmembers!A1:BA";
...
const SyncSingleMemberFromSheet = async (req, res) => {
  try {
...
const UpdateMemberFromSheet = async (req, res) => {
  try {
    const { membershipNo } = req.body;
...
export default {
  SyncSingleMemberFromSheet,
  UpdateMemberFromSheet,
};
