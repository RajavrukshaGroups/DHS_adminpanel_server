...
// #test
// const SHEET_RANGE = "Siteadvance!A:O";
...
const SyncSiteAdvanceFromTapasihalliSheet = async (req, res) => {
  try {
...
const UpdateSiteAdvanceFromTapasihalliSheet = async (req, res) => {
  try {
    const { uniqueRowId } = req.body;
...
export default {
  SyncSiteAdvanceFromTapasihalliSheet,
  UpdateSiteAdvanceFromTapasihalliSheet,
};
